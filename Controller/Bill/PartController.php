...
class Controller_Bill_PartController extends Controller_Abstract
{
    public function indexAction()
    {
        $this->getLayout()->getContent()
                          ->setBlock(Ccc::getBlock('bill/part_index'));
        $this->gridAction();     
    }
    public function gridAction()
    {
        $this->getLayout()->getContent()
                          ->setBlock(Ccc::getBlock('bill/part_list'));     
    }
    
    public function saveinsessionAction(){
        try
        {
            $partData = $this->getRequest()->getPost('part');
            $this->getRequest()->setSession('partData',$partData);
        ...
        $this->redirect('service_index','index');
    }

...
class Controller_Service_IndexController extends Controller_Abstract
{
    public function indexAction()
    {
        $this->getLayout()->getContent()
                          ->setBlock(Ccc::getBlock('service/index_index'));
        $this->gridAction();     
    }
    public function gridAction()
    {
        $this->getLayout()->getContent()
                          ->setBlock(Ccc::getBlock('service/index_list'));     
    }
    
    public function saveinsessionAction(){
        try
        {
            $serviceData = $this->getRequest()->getPost('service');
            $this->getRequest()->setSession('serviceData',$serviceData);
        }
        catch(Exception $e)
        {
            $e->getMessage();
        } 
        $this->redirect('bill_details','index');
    }
